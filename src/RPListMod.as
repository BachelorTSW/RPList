...
class RPListMod
{
	...
	function MakePlayersURL()
	{
		...
		URL = "https://pazuzucord.herokuapp.com/pazuzu/swlrp/rplist/update?playerId=" + m_clientID +"&nick=" + m_clientNick + "&firstName=" + m_clientFName + "&lastName=" + m_clientLName + "&playfieldId=" + m_clientPlayfieldID + "&players=" + PlayersURL + "&clearInstance=true";
